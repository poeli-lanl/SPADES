...
../run_SPADES.sh \
    -i SRR8959866_sampled_1000read.fastq.gz \
    -o SRR8959866_test_ont_sqc \
    -p SRR8959866_test_ont_sqc \
    -d gottcha2_database_test/gottcha_db.species.fna \
    -t 4 \
    --skip-qc \
    --ont-error-rate 0.03 \
...
../run_SPADES.sh \
    -1 SRR12689945_1_1k.fastq.gz \
    -2 SRR12689945_2_1k.fastq.gz \
    -o SRR12689945_test_PE_sqc \
    -p SRR12689945_test_PE_sqc \
    --skip-qc \
    -d gottcha2_database_test/gottcha_db.species.fna \
    --min-depth 5 \
    -t 4
...
# docker run --rm -it \
#   -v "$PWD":/work \
#   -v $PWD/gottcha2_database_test:/gottcha2_database_test:ro \
#   -w /work \
#   spades-g2:local \
#   /app/run_SPADES.sh \
#     -i /work/SRR12689945_1_1k.fastq.gz \
#     -o /work/SRR12689945_test_docker \
#     -p SRR12689945_test_docker \
#     -d /gottcha2_database_test/gottcha_db.species.fna \
#     -t 8